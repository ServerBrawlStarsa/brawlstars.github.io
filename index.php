...
<html>
    <head>
        ...
        <meta name="description" content="Необходимо открыть ссылку в Brawl Stars или скачать игру.">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, viewport-fit=cover, user-scalable=no"> 
        <meta itemprop="name" content="Brawl Stars">
        <meta itemprop="image" content="https://link.brawlstars.com/brawlstars_og.jpg">
        <meta property="og:title" content="Brawl Stars" />
        <meta property="og:description" content="Необходимо открыть ссылку в Brawl Stars или скачать игру." />
        <meta property="og:image" content="https://link.brawlstars.com/brawlstars_og.jpg" />          

        <link href="https://fonts.googleapis.com/css?family=Lilita+One&subset=latin-ext" rel="stylesheet">     

        <link rel="stylesheet" type="text/css" href="/build/0.4/css/styles.css" />
        <link rel="stylesheet" type="text/css" href="/build/0.4/css/brawlstars/brawlstars.css" />
       
    </head>
    <body class="app-brawlstars lang-ru" data-app="brawlstars" data-param="action" data-lang="ru" data-env="prod">

        <div id="page-wrap">

            <div id="lang">
                <div class="active" data-value="en">ру́сский</div>
                <select id="select-language">
                    <option value="id">Bahasa Indonesia</option><option value="ms">Bahasa Melayu</option><option value="de">Deutsch</option><option value="en">English</option><option value="es">Español</option><option value="fr">Français</option><option value="it">Italiano</option><option value="nl">Nederlands</option><option value="no">Norsk</option><option value="pl">Polski</option><option value="pt">Português</option><option value="fi">Suomi</option><option value="vi">Tiếng Việt</option><option value="tr">Türkçe</option><option value="ru" selected="selected">ру́сский</option><option value="he">עברית</option><option value="ar">العربية</option><option value="th">ไทย</option><option value="jp">日本語</option><option value="cn">简体中文</option><option value="cnt">繁體中文</option><option value="kr">한국어</option>                </select>
            </div>  

            <header>
                <h1 class="logo"><a href="https://brawlstars.com" title="Brawl Stars">Brawl Stars</a></h1>
            </header>              

            <div id="content-wrapper">
                
                <section id="app-installed">
                    <p>Чтобы открыть эту ссылку, необходимо иметь на этом устройстве игру Brawl Stars.</p>
                    <p><a href="#" id="button-open" class="button brand track-button">У меня есть Brawl Stars</a></p>
                    <p class="notes">&#8593; Если вы нажали, но ничего не произошло, попытайтесь открыть эту страницу в браузере.</p>                    
                </section>
                ...
                <section id="app-download">
                    <p>Скачивай бесплатно!</p>
                    <p class="buttons">
                        <a href="https://nnh-m.tlnk.io/serve?action=click&campaign_id_ios=429763&destination_id_ios=476514&publisher_id=362845&site_id_ios=135350&sub_site=default" data-url-custom="https://nnh-m.tlnk.io/serve?action=click&campaign_id_ios=429763&destination_id_ios=476514&publisher_id=362845&site_id_ios=135350" class="store store-cn appstore os-ios track-download translated">App Store</a>
                        <a href="https://svz-v.tlnk.io/serve?action=click&campaign_id_android=440732&destination_id_android=524866&publisher_id=363756&site_id_android=142069&sub_site=default" data-url-custom="https://svz-v.tlnk.io/serve?action=click&campaign_id_android=440732&destination_id_android=524866&publisher_id=363756&site_id_android=142069" class="store store-cn googleplay os-android track-download translated">Google Play</a>                    
                    </p>
                </section>            
        ...
        <script src="/build/0.4/js/app.min.js"></script>        
        <script src="/build/0.4/js/main.min.js"></script>



        <!-- Supercell Cookie Consent -->
        <script src="//cdn.supercell.com/cookieconsent/sc_cookieconsent.min.js?lang=ru"></script>

        <!-- Global site tag (gtag.js) - Google Analytics -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-99849052-4"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'UA-99849052-4');
        </script>
